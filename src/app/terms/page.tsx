...
export default function TermsPage() {
  return (
    <LegalPage kicker="legal" title="Terms" path="/terms">
      ...
      <h2 className="text-xl font-semibold tracking-tight text-paper sm:text-2xl">Who may use Held</h2>
      <p>
      ...
      <h2 className="text-xl font-semibold tracking-tight text-paper sm:text-2xl">Your page</h2>
      <p>
      ...
      <h2 className="text-xl font-semibold tracking-tight text-paper sm:text-2xl">Bookings and deposits</h2>
      <p>
      ...
      <h2 className="text-xl font-semibold tracking-tight text-paper sm:text-2xl">Demo</h2>
      <p>
        The Kade page is a demonstration. It cannot take a real deposit and is not an offer of work.
      </p>

      <h2 className="text-xl font-semibold tracking-tight text-paper sm:text-2xl">Acceptable use</h2>
      <p>
      ...
      <h2 className="text-xl font-semibold tracking-tight text-paper sm:text-2xl">Availability and changes</h2>
      <p>
      ...
      <h2 className="text-xl font-semibold tracking-tight text-paper sm:text-2xl">Language</h2>
      <p>
