...
export default function PrivacyPage() {
  return (
    <LegalPage kicker="legal" title="Privacy">
      ...
      <h2 className="font-display text-2xl text-paper">Who this covers</h2>
      <p>
      ...
      <h2 className="font-display text-2xl text-paper">Why we collect it</h2>
      <p>
      ...
      <h2 className="font-display text-2xl text-paper">Who else can see it</h2>
      <p>
      ...
      <h2 className="font-display text-2xl text-paper">How long we keep it</h2>
      <p>
      ...
      <h2 className="font-display text-2xl text-paper">Your choices</h2>
      <p>
      ...
      <h2 className="font-display text-2xl text-paper">Children</h2>
      <p>
      ...
      <h2 className="font-display text-2xl text-paper">Changes</h2>
      <p>
